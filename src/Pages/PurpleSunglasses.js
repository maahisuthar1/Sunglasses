...
function PurpleSunglasses({ addToCart, setCartOpen }) {
  ...
  const filteredProducts =
    selectedColors.length === 0
      ...
      : products.filter(
          (p) => p.section === "Sunglasses" && selectedColors.includes(p.color),
        );

  // const purpleProducts = products.filter(
  //   (product) => product.color === "Purple",
  // );
